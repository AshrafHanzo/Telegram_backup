...
pub async fn start_server(
    ...
    bw_manager: Arc<crate::bandwidth::BandwidthManager>,
    ...
    // Used by the folder-share ("Temp Link Generator") upload/update routes
    // and their shared password-verify rate limiter.
    let bw_data = web::Data::new(bw_manager);
    let net_data = web::Data::new(net_config);
    let verify_rate_limiter = web::Data::new(Arc::new(crate::share_common::VerifyRateLimiter::new()));
    ...
    let server = HttpServer::new(move || {
        ...
        App::new()
            ...
            .app_data(verify_rate_limiter.clone())
            .service(stream_media)
            .configure(crate::share_routes::configure_share_routes)
            .configure(crate::folder_share_routes::configure_folder_share_routes)
